...
export default function UploadPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await apiUpload<{ pin_id: string }>(
        "/pins/upload",
        fd,
        setUploadProgress,
      );
        ...
        <div className="grid lg:grid-cols-[1fr_380px] gap-6 items-start">
            ...
            {isUploading && (
              <div className="glass-card p-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-virens-white-muted">
                    Uploading...
                  </span>
                  <span className="text-sm font-medium text-virens-green">
                    {uploadProgress}%
                  </span>
                </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="glass-card p-4 flex flex-col gap-4">
              <h3 className="font-display font-semibold text-virens-white text-sm">
                Details
              </h3>

              <div>
                <label className="block text-xs text-virens-white-muted mb-1.5">
                  Title *
                </label>
                <input
                  value={form.title}
                ...
                {form.tags.length > 0 && (
                  <div className="flex flex-wrap gap-1.5 mt-2">
                    {form.tags.map((tag) => (
                      <span
                        key={tag}
                        className="badge-green text-xs flex items-center gap-1"
                      >
                        #{tag}
              ...
              <div className="flex items-center justify-between">
                ...
                <ToggleSwitch
                  ...
                  onChange={(v) =>
                    set("contentType", v ? "ai_generated" : "human")
                  }
                />
              </div>
              ...
              {(
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-sm text-virens-white">
                      {labels[perm]}
                    </span>
                  </label>
                );
            ...
            <div className="glass-card p-4 flex flex-col gap-3">
              ...
              {[
                {
                  key: "isProtected",
                  label: "Protected View Mode",
                  desc: "Disable right-click and drag",
                },
                {
                  key: "hasVisibleWatermark",
                  label: "Visible Watermark",
                  desc: "Show your username on the image",
                },
                {
                  key: "hasInvisibleWatermark",
                  label: "Invisible Watermark",
                  desc: "Embed your ID in pixel data",
                },
                {
                  key: "screenshotProtection",
                  label: "Screenshot Deterrence",
                  desc: "Add CSS overlay layer",
                },
              ].map(({ key, label, desc }) => (
                <div
                  key={key}
